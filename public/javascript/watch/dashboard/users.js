...
})({"hQBl5":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "8dbd0cab968b281c";
"use strict";
...
},{}],"1Cndd":[function(require,module,exports) {
var _usersView = require("../../views/dashboard/usersView");
var _model = require("../../models/model");
async function controlUserStatus(data, endUrl) {
    const response = await (0, _model.patchFull)(`/users/${endUrl}`, data);
    _usersView.renderUserStatus(response);
}
async function controlDeleteUser(userid) {
    const response = await (0, _model.deleteRequest)(`/users/${userid}`);
    _usersView.renderDeleteUser(response);
}
function init() {
    _usersView.initialize();
    _usersView.handleUserStatus(controlUserStatus);
    _usersView.handleDeleteUser(controlDeleteUser);
}
init();

},{"../../views/dashboard/usersView":"kHTZP","../../models/model":"4SBHD"}],"kHTZP":[function(require,module,exports) {
...
*/ // ============================== RENDERES
parcelHelpers.export(exports, "renderUserStatus", ()=>renderUserStatus);
//
parcelHelpers.export(exports, "renderDeleteUser", ()=>renderDeleteUser);
/*
...
*/ // ============================== HANDLERS
parcelHelpers.export(exports, "handleUserStatus", ()=>handleUserStatus);
//
parcelHelpers.export(exports, "handleDeleteUser", ()=>handleDeleteUser);
/*
...
function renderUserStatus(response) {
    ...
    if (next) next.insertAdjacentHTML("beforebegin", (0, _utils.userCard)(data));
    else if (prev) prev.insertAdjacentHTML("afterend", (0, _utils.userCard)(data));
    else container.insertAdjacentHTML("beforeend", (0, _utils.userCard)(data));
}
...
function handleUserStatus(controlUserStatus) {
...
function handleDeleteUser(controlDeleteUser) {
    container.addEventListener("click", async (ev)=>{
...
},{"../models/model":"4SBHD","./markup":"kNRSi","./utils":"hiLrG","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4SBHD":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hQBl5","1Cndd"], "1Cndd", "parcelRequiree8ef")
