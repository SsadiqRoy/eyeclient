...
})({"a3pC6":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "f48fb7a3e2f905fa";
"use strict";
...
},{}],"2Zgxn":[function(require,module,exports) {
var _model = require("../../models/model");
var _seriesView = require("../../views/dashboard/seriesView");
async function controlSeries(id) {
    const url = id ? `/media/hard/${id}` : "/media/hard";
    const data = _seriesView.getData();
    const response = id ? await (0, _model.patchFull)(url, data) : await (0, _model.postFull)(url, data);
    _seriesView.renderSeries(response, id);
}
//
async function controlSeason() {
    const data = _seriesView.getSeasonData();
    const response = await (0, _model.postFull)("/media/Season", data);
    _seriesView.renderSeason(response);
}
async function controlDeleteSeason(id) {
    await (0, _model.deleteRequest)(`/media/season/${id}`);
    _seriesView.renderDeleteSeason(id);
}
async function init() {
    _seriesView.initialize();
    _seriesView.handleSeries(controlSeries);
    _seriesView.handleSeason(controlSeason);
    _seriesView.handleDeleteSeason(controlDeleteSeason);
}
init();

},{"../../models/model":"4SBHD","../../views/dashboard/seriesView":"32lQ5"}],"4SBHD":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"32lQ5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/*
...
*/ // ============================== RENDERES
parcelHelpers.export(exports, "renderSeries", ()=>renderSeries);
//
parcelHelpers.export(exports, "renderSeason", ()=>renderSeason);
...
*/ // ============================== HANDLERS
parcelHelpers.export(exports, "handleSeries", ()=>handleSeries);
parcelHelpers.export(exports, "handleSeason", ()=>handleSeason);
...
let currentSeason;
function renderSeries(response, id) {
...
function handleSeries(controlSeries) {
...
function handleSeason(controlSeason) {
    ...
    form && form.addEventListener("submit", async (ev)=>{
        ...
        try {
            ...
            (0, _utils.closePopup)("season-popup", clearSeasonPopup);
        } catch (error) {
...
function editSeasonPopup(season) {
    ...
    document.getElementById("season-released").value = (0, _utils.unmergeDate)(season.released).date;
}
function onEditSeason() {
    container && container.addEventListener("click", (ev)=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./functions":"hZORM"}]},["a3pC6","2Zgxn"], "2Zgxn", "parcelRequiree8ef")
