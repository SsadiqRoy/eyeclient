...
})({"44Tjg":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "7814fd9e58066e53";
"use strict";
...
},{}],"3d6UO":[function(require,module,exports) {
var _mediaView = require("../../views/dashboard/mediaView");
var _model = require("../../models/model");
async function controlDeleteMedia(mediaid) {
    const response = await (0, _model.deleteRequest)(`/media/single/${mediaid}`);
    _mediaView.renderDeleteMedia(response);
}
async function controlSoftAdd(data) {
    const response = await (0, _model.postFull)("/media/soft", data);
    _mediaView.renderSoftAdd(response);
}
function init() {
    _mediaView.initialize();
    _mediaView.handleDeleteMedia(controlDeleteMedia);
    _mediaView.handleSoftAdd(controlSoftAdd);
}
init();

},{"../../views/dashboard/mediaView":"96YkM","../../models/model":"4SBHD"}],"96YkM":[function(require,module,exports) {
...
*/ // ============================== RENDERES
parcelHelpers.export(exports, "renderDeleteMedia", ()=>renderDeleteMedia);
//
parcelHelpers.export(exports, "renderSoftAdd", ()=>renderSoftAdd);
/*
...
*/ // ============================== HANDLERS
parcelHelpers.export(exports, "handleDeleteMedia", ()=>handleDeleteMedia);
//
parcelHelpers.export(exports, "handleSoftAdd", ()=>handleSoftAdd);
/*
...
function renderDeleteMedia(response) {
    const { data, message } = response;
    (0, _utils.alertResponse)(message);
    const card = document.querySelector(`[data-media-id='${data.id}']`);
    container.removeChild(card);
}
function renderSoftAdd(response) {
    const { data, message } = response;
    (0, _utils.alertResponse)(message);
    container.insertAdjacentHTML("afterbegin", (0, _utils.dmediaCard)(data));
}
function handleDeleteMedia(controlDeleteMedia) {
...
function handleSoftAdd(controlSoftAdd) {
    ...
    form.addEventListener("submit", async (ev)=>{
        ...
        try {
            await controlSoftAdd({
                imdbId
            });
            (0, _utils.stopRotateBtn)(btnid);
            (0, _utils.closePopup)("soft-add-popup", ()=>document.getElementById("imdb-id").value = "");
        } catch (error) {
