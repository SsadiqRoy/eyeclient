...
})({"fiKpd":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "aa44153639b19916";
"use strict";
...
},{}],"ikUk5":[function(require,module,exports) {
var _model = require("../../models/model");
var _movieView = require("../../views/dashboard/movieView");
async function controlMovie(id) {
    const url = id ? `/media/hard/${id}` : "/media/hard";
    const data = _movieView.getData();
    const response = id ? await (0, _model.patchFull)(url, data) : await (0, _model.postFull)(url, data);
    _movieView.renderMovie(response, id);
}
//
async function controlLink(id) {
    const data = _movieView.getLinkData();
    const response = id ? await (0, _model.patchFull)(`/media/link/${id}`, data) : await (0, _model.postFull)("/media/link", data);
    _movieView.renderLink(response);
}
async function controlDeleteLink(id) {
    await (0, _model.deleteRequest)(`/media/link/${id}`);
    _movieView.renderDeleteLink(id);
}
async function init() {
    _movieView.initialize();
    _movieView.handleMovie(controlMovie);
    _movieView.handleLink(controlLink);
    _movieView.handleDeleteLink(controlDeleteLink);
}
init();

},{"../../models/model":"4SBHD","../../views/dashboard/movieView":"8bvff"}],"4SBHD":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8bvff":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/*
...
//
parcelHelpers.export(exports, "renderLink", ()=>renderLink);
...
*/ // ============================== HANDLERS
parcelHelpers.export(exports, "handleMovie", ()=>handleMovie);
parcelHelpers.export(exports, "handleLink", ()=>handleLink);
...
let currentLink;
function renderMovie(response, id) {
...
function handleMovie(controlMovie) {
...
function handleLink(controlLink) {
    ...
    form && form.addEventListener("submit", async (ev)=>{
        ...
        try {
            ...
            (0, _utils.closePopup)("link-popup", clearLinkPopup);
        } catch (error) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["fiKpd","ikUk5"], "ikUk5", "parcelRequiree8ef")
