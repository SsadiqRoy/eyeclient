...
})({"8K4Cl":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "33058937eda6b5bd";
"use strict";
...
},{}],"l63xR":[function(require,module,exports) {
var _model = require("../../models/model");
var _gameView = require("../../views/dashboard/gameView");
async function controlGame(id) {
    const url = id ? `/media/hard/${id}` : "/media/hard";
    const data = _gameView.getData();
    const response = id ? await (0, _model.patchFull)(url, data) : await (0, _model.postFull)(url, data);
    _gameView.renderGame(response, id);
}
//
async function controlLink(id) {
    const data = _gameView.getLinkData();
    const response = id ? await (0, _model.patchFull)(`/media/link/${id}`, data) : await (0, _model.postFull)("/media/link", data);
    _gameView.renderLink(response);
}
async function controlDeleteLink(id) {
    await (0, _model.deleteRequest)(`/media/link/${id}`);
    _gameView.renderDeleteLink(id);
}
async function init() {
    _gameView.initialize();
    _gameView.handleGame(controlGame);
    _gameView.handleLink(controlLink);
    _gameView.handleDeleteLink(controlDeleteLink);
}
init();

},{"../../models/model":"4SBHD","../../views/dashboard/gameView":"as41E"}],"4SBHD":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"as41E":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/*
...
*/ // ============================== RENDERES
parcelHelpers.export(exports, "renderGame", ()=>renderGame);
//
...
*/ // ============================== HANDLERS
parcelHelpers.export(exports, "handleGame", ()=>handleGame);
...
let currentLink;
function renderGame(response, id) {
...
function getLinkData() {
    ...
    return {
        ...
        position,
        link,
        filled: link.length ? true : false
    };
}
function handleGame(controlGame) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./functions":"hZORM"}]},["8K4Cl","l63xR"], "l63xR", "parcelRequiree8ef")
