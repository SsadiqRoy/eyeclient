...
})({"iFdKF":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "97597dbb31b22c17";
"use strict";
...
},{}],"aG3zf":[function(require,module,exports) {
var _newView = require("../../views/dashboard/newView");
var _model = require("../../models/model");
async function controlNewUser() {
    const data = _newView.getUserData();
    // console.log(data);
    const response = await (0, _model.postFull)("/users/new", data);
    _newView.renderNewUser(response);
}
function init() {
    // view.initialize();
    _newView.handleNewUser(controlNewUser);
}
init();

},{"../../views/dashboard/newView":"kFzGF","../../models/model":"4SBHD"}],"kFzGF":[function(require,module,exports) {
...
*/ // ============================== RENDERES
parcelHelpers.export(exports, "renderNewUser", ()=>renderNewUser);
/*
...
*/ // ============================== HANDLERS
parcelHelpers.export(exports, "handleNewUser", ()=>handleNewUser) /*
...
function renderNewUser(response) {
...
function handleNewUser(controlNewUser) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["iFdKF","aG3zf"], "aG3zf", "parcelRequiree8ef")
