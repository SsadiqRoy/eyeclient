...
})({"5jQYb":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "392e5aeef6cabf75";
"use strict";
...
},{}],"a8DlA":[function(require,module,exports) {
var _loginView = require("../../views/dashboard/loginView");
var _model = require("../../models/model");
async function controlLogin() {
    const data = _loginView.getLogins();
    const response = await (0, _model.postSimple)("/users/login", data);
    _loginView.renderLogin(response);
}
function init() {
    // view.initializer();
    _loginView.handleLogin(controlLogin);
}
init();

},{"../../views/dashboard/loginView":"ciVme","../../models/model":"4SBHD"}],"ciVme":[function(require,module,exports) {
...
*/ // ============================== GETTERS
parcelHelpers.export(exports, "getLogins", ()=>getLogins);
/*
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["5jQYb","a8DlA"], "a8DlA", "parcelRequiree8ef")
