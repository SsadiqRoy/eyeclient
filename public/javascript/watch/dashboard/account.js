...
},{}],"fXs5L":[function(require,module,exports) {
var _accountView = require("../../views/dashboard/accountView");
var _model = require("../../models/model");
async function controlUpdate() {
    const data = _accountView.getUpdate();
    const response = await (0, _model.patchFull)("/users", data);
    _accountView.renderUpdate(response);
}
//
async function controlChangePassword() {
    const data = _accountView.getPasswords();
    const response = await (0, _model.patchFull)("/users/password", data);
    _accountView.renderChangePassword(response);
}
function init() {
    _accountView.handleUpdate(controlUpdate);
    _accountView.handleChangePassword(controlChangePassword);
}
init();

},{"../../views/dashboard/accountView":"3Yb8n","../../models/model":"4SBHD"}],"3Yb8n":[function(require,module,exports) {
// ============================= CONSTANT VARIABLES
...
*/ // ============================== RENDERES
parcelHelpers.export(exports, "renderUpdate", ()=>renderUpdate);
parcelHelpers.export(exports, "renderChangePassword", ()=>renderChangePassword);
/*
...
function renderChangePassword(response) {
    (0, _utils.alertResponse)(response.message);
...
function handleUpdate(controlUpdate) {
