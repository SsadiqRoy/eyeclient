...
})({"2H4Ou":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "4cbcdab26b024368";
"use strict";
...
},{}],"fZ5x2":[function(require,module,exports) {
var _homeView = require("../../views/clients/homeView");
var _model = require("../../models/model");
//
async function controlInitialLoad(slider) {
    const response = await (0, _model.getSimple)(`/media${slider.query}`);
    _homeView.renderSlider(response, slider);
}
//
async function init() {
    _homeView.initialize();
    // window.setTimeout(() => view.handleInitialLoad(controlInitialLoad), 3000);
    _homeView.handleInitialLoad(controlInitialLoad);
}
init();

},{"../../views/clients/homeView":"9MvOQ","../../models/model":"4SBHD"}],"9MvOQ":[function(require,module,exports) {
...
*/ // ============================== RENDERES
parcelHelpers.export(exports, "renderSlider", ()=>renderSlider);
/*
...
*/ // ============================== HANDLERS
parcelHelpers.export(exports, "handleInitialLoad", ()=>handleInitialLoad);
/*
...
*/ // ============================== NON-EXPORTING
parcelHelpers.export(exports, "scrollSlider", ()=>scrollSlider);
var _utils = require("../../utils/utils");
// ============================= CONSTANT VARIABLES
const sliders = {
    home: [
        {
            title: 'In Theathers <i class="fa-solid fa-angles-right"></i>',
        ...
        },
        {
            ...
            query: "?type=game&imdbRating[gt]=6.9"
        },
        {
            title: 'Highly Rated Movies <i class="fa-solid fa-angles-right"></i>',
            query: "?type=movie&imdbRating[gt]=6.9"
        },
        {
            title: 'Highly Rated Series <i class="fa-solid fa-angles-right"></i>',
            query: "?type=series&imdbRating[gt]=6.9"
        },
        {
            title: 'Major collections <i class="fa-solid fa-angles-right"></i>',
            query: "?type=collection&imdbRating[gt]=6.9"
        },
        {
        ...
        },
        {
            ...
            query: "?search=action,adventure&type=game"
        },
        {
            title: 'Drama Series & Movies <i class="fa-solid fa-angles-right"></i>',
            query: "?search=drama&type[ne]=collection"
        },
        {
    ...
    movies: [
        {
            title: 'New Release <i class="fa-solid fa-angles-right"></i>',
            query: "?type=movie&order=-released"
        },
        {
            title: 'In Theaters <i class="fa-solid fa-angles-right"></i>',
            query: "?type=movie&imdbRating[gt]=7&order=-released"
        },
        {
            title: 'Top - This Year <i class="fa-solid fa-angles-right"></i>',
            query: "?type=movie&imdbRating[gt]=7.5&released[gte]=2024-01-01"
        },
        {
        ...
        {
            title: 'Top All Time <i class="fa-solid fa-angles-right"></i>',
            query: "?type=movie&imdbRating[gt]=7.5"
        },
        {
            title: 'animation <i class="fa-solid fa-angles-right"></i>',
            query: "?type=movie&search=animation"
        },
        {
            title: 'comedy <i class="fa-solid fa-angles-right"></i>',
            query: "?type=movie&search=comedy"
        },
        {
            title: 'action <i class="fa-solid fa-angles-right"></i>',
            query: "?type=movie&search=action"
        },
        {
            title: 'netflix <i class="fa-solid fa-angles-right"></i>',
            query: "?type=movie&search=netflix"
        },
        {
        ...
        },
        {
            ...
            query: "?type=movie&search=Apple Tv"
        },
        {
            title: 'disney <i class="fa-solid fa-angles-right"></i>',
            query: "?type=movie&search=disney"
        }
    ],
    series: [
        {
            title: 'Trending now <i class="fa-solid fa-angles-right"></i>',
            query: "?type=series&imdbRating[gt]=7&order=-released"
        },
        {
            title: 'New Episodes <i class="fa-solid fa-angles-right"></i>',
            query: "?type=series&order=-lastEpisodeOn"
        ...
        {
            title: 'Top - This Year <i class="fa-solid fa-angles-right"></i>',
            query: "?type=series&imdbRating[gt]=7.5&released[gte]=2024-01-01"
        },
        {
            title: 'Top - Previous Years <i class="fa-solid fa-angles-right"></i>',
        ...
        {
            title: 'Top All Time <i class="fa-solid fa-angles-right"></i>',
            query: "?type=series&imdbRating[gt]=7.5"
        },
        {
            title: 'animation <i class="fa-solid fa-angles-right"></i>',
            query: "?type=series&search=animation"
        },
        {
            title: 'comedy <i class="fa-solid fa-angles-right"></i>',
            query: "?type=series&search=comedy"
        },
        {
            title: 'action <i class="fa-solid fa-angles-right"></i>',
            query: "?type=series&search=action"
        },
        {
            title: 'netflix <i class="fa-solid fa-angles-right"></i>',
            query: "?type=series&search=netflix"
        },
        {
            title: 'Prime Video <i class="fa-solid fa-angles-right"></i>',
        ...
        {
            title: 'Apple Tv <i class="fa-solid fa-angles-right"></i>',
            query: "?type=series&search=Apple Tv"
        },
        {
            title: 'HBO <i class="fa-solid fa-angles-right"></i>',
            query: "?type=series&search=hbo"
        }
    ],
    games: [
        {
            title: 'New Release <i class="fa-solid fa-angles-right"></i>',
            query: "?type=game&order=-released"
        },
        {
            title: 'Top Games <i class="fa-solid fa-angles-right"></i>',
            query: "?type=game&imdbRating[gt]=6.9"
        ...
        {
            title: 'Collections <i class="fa-solid fa-angles-right"></i>',
            query: "?type=collection&collectionType=game&order=-released"
        }
    ],
    collections: [
        {
            title: 'movie Collections <i class="fa-solid fa-angles-right"></i>',
            query: "?type=collection&collectionType=movie&order=-released"
        },
        {
            title: 'series Collections <i class="fa-solid fa-angles-right"></i>',
            query: "?type=collection&collectionType=series&order=-released"
        },
        {
            title: 'game Collections <i class="fa-solid fa-angles-right"></i>',
            query: "?type=collection&collectionType=game&order=-released"
        },
        {
            title: 'Major Collections <i class="fa-solid fa-angles-right"></i>',
            query: "?type=collection&imdbRating[gte]=7.5&order=-released"
        }
    ]
};
function renderSlider(data, slider) {
  ...
  `;
    ...
    data.forEach((media)=>container.insertAdjacentHTML("beforeend", (0, _utils.mediaCard)(media)));
    ...
    const query = (0, _utils.parseQuery)(slider.query);
    excluded.forEach((field)=>delete query[field]);
    const seemore = `
  <div class="see-more-card">
    <a href="/media${(0, _utils.stringifyQuery)(query)}">See More</a>
  </div>
  `;
    container.insertAdjacentHTML("beforeend", seemore);
}
function handleInitialLoad(controlInitialLoad) {
    window.addEventListener("DOMContentLoaded", async ()=>{
        ...
        for(let i = 0; i < pageSliders.length; i++){
            ...
            try {
                slider.query = (0, _utils.stringifyQuery)({
                    ...(0, _utils.parseQuery)(slider.query),
                    ...(0, _utils.parseQuery)(extraQuery)
                });
...
const client_url = "http://localhost:3100"; // export const api_url = 'https://api.eyeclient.com/v1';
...
function dmediaCard(media, buttonType = "") {
  ...
  `;
    ...
    const fullContent = `.\nTitle: ${media.title}
\u{1F37F}Download Here\u{1F37F} - https://eyeclient.com${link}\n${media.plot || ""}\n${genre}

\u{1F37F}\u{1F37F}\u{1F37F}\u{1F37F}\u{1F37F}
${imdbPath}`;
...
parcelHelpers.export(exports, "postSimple", ()=>postSimple);
parcelHelpers.export(exports, "postFull", ()=>postFull);
parcelHelpers.export(exports, "patchSimple", ()=>patchSimple);
parcelHelpers.export(exports, "patchFull", ()=>patchFull);
parcelHelpers.export(exports, "deleteRequest", ()=>deleteRequest);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _env = require("../utils/env");
async function getSimple(url, fullurl = "api") {
    try {
        url = fullurl === "api" ? `${0, _env.api_url}${url}` : fullurl;
...
async function getFull(url, fullurl = "api") {
    try {
        url = fullurl === "api" ? `${0, _env.api_url}${url}` : fullurl;
        const response = await (0, _axiosDefault.default)({
            method: "GET",
...
async function postSimple(url, data, fullurl = "api") {
    try {
        url = fullurl === "api" ? `${0, _env.api_url}${url}` : fullurl;
        const response = await (0, _axiosDefault.default)({
            method: "POST",
...
async function postFull(url, data, fullurl = "api") {
    try {
        url = fullurl === "api" ? `${0, _env.api_url}${url}` : fullurl;
        const response = await (0, _axiosDefault.default)({
            method: "POST",
...
async function patchSimple(url, data, fullurl = "api") {
    try {
        url = fullurl === "api" ? `${0, _env.api_url}${url}` : fullurl;
        const response = await (0, _axiosDefault.default)({
            method: "PATCH",
...
async function patchFull(url, data, fullurl = "api") {
    try {
        url = fullurl === "api" ? `${0, _env.api_url}${url}` : fullurl;
        const response = await (0, _axiosDefault.default)({
            method: "PATCH",
...
async function deleteRequest(url, fullurl = "api") {
    try {
        url = fullurl === "api" ? `${0, _env.api_url}${url}` : fullurl;
        const response = await (0, _axiosDefault.default)({
            method: "DELETE",
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["2H4Ou","fZ5x2"], "fZ5x2", "parcelRequiree8ef")
