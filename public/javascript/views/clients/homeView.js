...
const sliders = {
  home: [
    ...
    { title: 'Animation <i class="fa-solid fa-angles-right"></i>', query: '?search=animation&order=-released' },
    ...
    { title: 'Korean <i class="fa-solid fa-angles-right"></i>', query: '?search=korea&order=-released' },
    { title: 'On Netflix <i class="fa-solid fa-angles-right"></i>', query: '?search=netflix&order=-released' },
    { title: 'On Prime Video <i class="fa-solid fa-angles-right"></i>', query: '?search=amazon&order=-released' },
    { title: 'On Apple Tv <i class="fa-solid fa-angles-right"></i>', query: '?search=apple&order=-released' },
    { title: 'On HBO <i class="fa-solid fa-angles-right"></i>', query: '?search=hbo&order=-released' },
  ],
  movies: [
